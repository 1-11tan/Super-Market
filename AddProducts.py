...
class sup:
    ...
    def reset(self):
        ...
        self.txt6.delete(0,tkinter.END)

    def add_product(self):
        if self.txt1.get()=="":
            tkinter.messagebox.showerror("Super Market","Product Code is Mandatory")
        elif self.txt2.get()=="":
            tkinter.messagebox.showerror("Super Market","Product Name is Mandatory")
        elif self.txt3.get()=="":
            tkinter.messagebox.showerror("Super Market","Price")
        elif self.txt4.get()=="":
            tkinter.messagebox.showerror("Super Market","Offer")
        elif self.txt5.get()=="":
            tkinter.messagebox.showerror("Super Market","Enter Discount")
        elif not self.txt3.get().isdigit() or not self.txt5.get().isdigit():
            tkinter.messagebox.showerror("Super Market","Enter Valid Price or Discount")
        elif self.txt6.get()=="":
            tkinter.messagebox.showerror("Super Market","Enter Customer Details")
        elif self.product_exist(self.txt1.get()):
            tkinter.messagebox.showerror("Super Market","Product Already Exists")
        else:
            x = [self.txt1.get(), self.txt2.get(), self.txt3.get(), self.cb1.get(), self.txt4.get(), self.txt5.get(),self.txt6.get()]
